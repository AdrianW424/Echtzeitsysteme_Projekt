...
def openFromCSV(content):
    ...
    flag, res = inputChecker.checkInput(content, [inputChecker.checkColumns, inputChecker.checkEmptyCells, inputChecker.checkForUniqueIDs, inputChecker.checkSemaphores, inputChecker.checkColumnValues]) 
